...
public class OctoPnPPackAndPublishRunType extends RunType {
    private final PluginDescriptor pluginDescriptor;

    public OctoPnPPackAndPublishRunType(final RunTypeRegistry runTypeRegistry, final PluginDescriptor pluginDescriptor) {
    ...
    public String getType() {
        return OctopusConstants.OCTOPNP_PACK_AND_PUBLISH_RUNNER_TYPE;
    }
    ...
    public String getEditRunnerParamsJspFilePath() {
        return pluginDescriptor.getPluginResourcesPath("editOctoPnPPackAndPublish.jsp");
    }

    @Nullable
    @Override
    public String getViewRunnerParamsJspFilePath() {
        return pluginDescriptor.getPluginResourcesPath("viewOctoPnPPackAndPublish.jsp");
    }
